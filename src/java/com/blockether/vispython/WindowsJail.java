...
public final class WindowsJail implements AutoCloseable {
  ...
  /**
   * Root of the private temporary and application-data tree. Each child's TEMP,
   * TMP and LOCALAPPDATA point to pre-created per-profile subdirectories here.
   */
   ...
   * TEMP/TMP/LOCALAPPDATA use private per-profile subdirectories beneath
   * {@link #temporaryDirectory()}; SystemRoot uses the OS-derived Windows
   * directory. These override caller values.
   *
